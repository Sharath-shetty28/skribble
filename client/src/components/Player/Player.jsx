...
export default function Player({ player, order }) {
  ...
  return (
    <div
      className={`player-container ${order % 2 === 0 && "player-odd"} ${
        hasGuessed && !isDrawing && !isChoosing ? "player-guessed" : ""
      }`}
    >
      ...
      <div className="avatar">
        <img
          src={`https://avataaars.io/?topType=${top}&clotheType=${clothe}&clotheColor=Black&eyeType=${eye}&mouthType=${mouth}`}
          alt="avatar"
        />
      </div>
    </div>
