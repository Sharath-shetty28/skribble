  ...
  return (
    <div className="home">
      <form onSubmit={login} className="info">
        ...
        <div className="pic">
          <div className="less-than gap-12 flex flex-col cursor-pointer">
            {types.map((type, index) => (
              <button
                className="cursor-pointer"
                type="button"
                key={index}
                onClick={() => decrementStyle(type)}
              >
                {/* <img key={index} src={lessThan} alt="less than" /> */}
                <FaLessThan key={index} alt="less than" />
              </button>
            ))}
          </div>
          <img
          ...
          <div className="greater-than">
            {types.map((type, index) => (
              ...
              >
                <FaGreaterThan key={index} alt="greater than" />
